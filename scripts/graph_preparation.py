...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_of_vertices', type=int, default=358)  # 03:358, 04:307, 07:883, 08:170
    ...
    parser.add_argument('--data_filename', type=str, default='../data/PEMS03/PEMS03.npz',
                        help='CSV file containing sensor distances with three columns: [from, to, distance].')
    parser.add_argument('--edgelist_filename', type=str, default='../data/PEMS03/PEMS03.edgelist',
                        help='CSV file containing sensor distances with three columns: [from, to, distance].')
    parser.add_argument('--flow_mean', type=str, default='../data/PEMS03/PEMS03_flow_count.pkl',
